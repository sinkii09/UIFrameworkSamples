...
What changed in this project and why, newest first. For bug fixes: what broke, the root cause,
the fix.

Split out of [`codebase-summary.md`](codebase-summary.md) on 2026-09-20. That file had reached
1,867 lines against an 800-line cap and this section was 78% of it, so the part that answers
*"what is this project right now"* was buried under months of history. **That file describes the
current state; this one records how it got there.**
